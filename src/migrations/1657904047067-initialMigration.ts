...
export class initialMigration1657904047067 implements MigrationInterface {
    name = 'initialMigration1657904047067'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Rooms" ("id" uuid NOT NULL, "roomNumber" integer NOT NULL, "floorNumber" integer NOT NULL, "price" numeric(8,2) NOT NULL, "isClean" boolean NOT NULL, "isAvailable" boolean NOT NULL, "hotelId" uuid, "roomTypeId" integer, CONSTRAINT "UQ_32d4c5d25a565f95b283fe641b5" UNIQUE ("roomNumber"), CONSTRAINT "PK_f120a70aaf1cecbd6c1ac8f1c23" PRIMARY KEY ("id"))`);
